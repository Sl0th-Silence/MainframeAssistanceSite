    ...
    return (
        <div className="mainPage">
            ...
            <p>
                ...
                I am going to add in what I feel is important but this will act as a more comprehesible guide then that of IBM's site.
            </p>
            <hr/>
            <br/><br/>
            ...
            <div>
                <select name="PageSelectHome" id="PageSelectHome" onChange={handleChange} value={selectedPage}>
