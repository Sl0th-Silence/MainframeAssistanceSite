...
{   
    <div className="info">
        ...
        <img src="public/select-option.png" alt="selectOption" width="150px" height="150px"/>
        <img src="public/Command-option.png" alt="commandOption" width="150px" height="150px"/>
        ...
        <img src="public/F-WS-PAGE-NUM.png" alt="F-WS-PAGE-NUM" width="150px" height="150px"/>

        <p>They also are not case sensitive for searching.</p>
        
        <img src="public/f-string.png" alt="f-string" width="150px" height="150px"/>
}